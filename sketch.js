var knife, knifeImage, alien, alienImage, fruit1, fruit2,
...
function alien(){
 ...
 var alien=createSprite(600,Math.round(random(30,400)),10,10)
  
 alien.addAnimation("alien_blinking",alienImage)
  alien.velocityX=-6
  alien.scale=0.75
  alien.lifetime=150
  alien.add(alien)
